          ...
          <Reveal className="lg:col-span-6">
            ...
            <div className="mt-6 grid gap-3 sm:grid-cols-2">
              {pillars.map((p) => (
                <div
                  key={p.title}
                  className="flex items-center gap-3 rounded-xl border border-ink/[0.06] bg-ink/[0.02] px-4 py-3"
                >
                  <p.icon className="size-4 text-accent" />
                  <span className="text-[14px] text-ink/80">{p.title}</span>
                </div>
              ))}
            </div>
          ...
          <Reveal className="lg:col-span-6" delay={0.1}>
            <div className="relative">
              ...
              <div className="grid grid-cols-2 gap-3">
                <div className="aspect-square overflow-hidden rounded-2xl border border-ink/[0.08] bg-surface">
                  <Image
                ...
                <div className="col-span-2 aspect-[2/1] overflow-hidden rounded-2xl border border-ink/[0.08] bg-surface">
                  <Image
