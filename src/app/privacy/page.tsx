    ...
    <section className="pt-32 pb-24">
      <Container className="max-w-3xl">
        ...
        <div className="prose prose-invert mt-8 max-w-none text-ink/75">
          ...
          <h2 className="mt-8 font-display text-xl font-semibold text-ink">Information we collect</h2>
          ...
          <h2 className="mt-8 font-display text-xl font-semibold text-ink">How we use it</h2>
          <ul className="list-disc pl-6 space-y-2 text-[15px] leading-relaxed">
          ...
          <h2 className="mt-8 font-display text-xl font-semibold text-ink">Data sharing</h2>
          <p>
          ...
          <h2 className="mt-8 font-display text-xl font-semibold text-ink">Your rights</h2>
          <p>
