  ...
  return (
    <section className="pt-32 pb-24">
      <Container className="max-w-3xl">
        ...
        <p className="mt-3 text-[14px] text-ink/55">Last updated: 16 May 2026</p>

        <div className="prose prose-invert mt-8 max-w-none text-ink/75">
          ...
          <h2 className="mt-8 font-display text-xl font-semibold text-ink">Engagements</h2>
          <p>
          ...
          <h2 className="mt-8 font-display text-xl font-semibold text-ink">Intellectual property</h2>
          <p>
          ...
          <h2 className="mt-8 font-display text-xl font-semibold text-ink">Third-party links</h2>
          <p>
          ...
          <h2 className="mt-8 font-display text-xl font-semibold text-ink">Limitation of liability</h2>
          <p>
          ...
          <h2 className="mt-8 font-display text-xl font-semibold text-ink">Changes</h2>
          <p>
          ...
          <p>
            ...
            <a className="text-accent hover:underline" href="mailto:saadalamtrohli106@gmail.com">
